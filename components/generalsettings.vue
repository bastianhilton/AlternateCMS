            ...
            <table class="table" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><FormulateInput v-model="siteUrl" type="text" name="Type">
                            </FormulateInput></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">Adminstration Email Address</td>
                        <td><FormulateInput v-model="siteAdminEmail" type="text" name="Type">
                            </FormulateInput></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">Your Industry</td>
                        <td><FormulateInput
        v-model="value" :options="{first: 'Apps and Games', second: 'Athletic/Sporting Goods', third: 'Arts and Design', fourth: 'Auto Parts'}" type="select" placeholder="Select an option" label="--Please Select--"
      /></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td><FormulateInput v-model="tagline" type="text" required label="AWS S3 is a storage service by Amazon." /></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">Google Drive API Key</td>
                        <td><FormulateInput v-model="tagline" type="text" name="Type" label="Google Drive is a personal cloud storage service by Google.">
                            </FormulateInput></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td><FormulateInput v-model="value" :options="{first: 'OFF', second: 'ON'}" type="radio"
  label="Enabling this option will generate multiple formats (small, medium and large) of the uploaded asset." /></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">Size Optimization</td>
                        <td><FormulateInput v-model="tagline" :options="{first: 'OFF', second: 'ON'}" type="radio"
  label="Enabling this option will reduce the image size and slightly reduce its quality." /></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">Auto Orientation</td>
                        <td><FormulateInput v-model="siteUrl" :options="{first: 'OFF', second: 'ON'}" type="radio"
  label="Enabling this option will automatically rotate the image according to EXIF orientation tag." /></td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table class="table" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td><FormulateInput v-model="languages" :options="{first: 'First', second: 'Second', third: 'Third', fourth: 'Fourth'}" type="select" placeholder="Select an option" label="List of store languages" /></td>
                    </tr>
                </tbody>
            </table>
        </div>
