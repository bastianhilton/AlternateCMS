            ...
            <div>
              ...
              <div class="table table-responsive">
                <table id="table" data-toggle="table" class="table">
                  ...
                  <tbody v-for="tax_rule in taxRules" :key="tax_rule.id">
                    <tr>
                      <td>{{ tax_rule.id }}</td>
                      <td>{{ tax_rule.name }}</td>
...
<script>
  ...
  import {
    generalSettings
  } from "~/graphql/queries/system/settingsgeneral";
  import paymentsettings from '~/components/settings/paymentsettings';
  import currencies from '~/graphql/queries/system/currencies'
  import cities from '~/graphql/queries/shop/cities'
  import states from '~/graphql/queries/shop/states'
  import countries from '~/graphql/queries/shop/countries'
  import channels from '~/graphql/queries/system/channels'
  import zones from '~/graphql/queries/system/zones'
  import taxRates from '~/graphql/queries/shop/taxrate'
  import taxRules from '~/graphql/queries/shop/taxrule'
