  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
          <div class="dropdown">
            <button id="dropdownMenuButton" class="btn btn-primary dropdown-toggle" type="button"
          ...
          <div class="dropdown" style="float:left; left: 8%; position: absolute;">
            <button id="dropdownMenuButton" class="btn btn-primary dropdown-toggle" type="button"
              data-mdb-toggle="dropdown" aria-expanded="false">
              Newsletters
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <li><a class="dropdown-item" href="#">Newsletter Templates</a></li>
              <li><a class="dropdown-item" href="#">Newsletter Queue</a></li>
              <li><a class="dropdown-item" href="#">Newsletter Subscribers</a></li>
            </ul>
          </div>
