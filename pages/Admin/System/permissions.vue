  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand"><button type="button" class="btn btn-primary">Add New User</button></a>
        <a class="navbar-brand"><button type="button" class="btn btn-primary" style="float:left; left: 13%; position: absolute;">Locked Users</button></a>
        <a class="navbar-brand"><button type="button" class="btn btn-primary" style="float:left; left: 25%; position: absolute;">User Roles</button></a>
