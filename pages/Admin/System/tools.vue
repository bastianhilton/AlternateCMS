  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand"><button type="button" class="btn btn-primary">Cache Management</button></a>
        <a class="navbar-brand"><button type="button" class="btn btn-primary" style="float:left; left: 13%; position: absolute;">Index Management</button></a>
        <a class="navbar-brand"><button type="button" class="btn btn-primary" style="float:left; left: 25%; position: absolute;">Backups</button></a>
        ...
        <ul class="navbar-nav">
          ...
          <form action="/" class="filterAction">
            ...
            <select id="actions" name="actions">
              ...
              <option value="saab">Refresh All</option>
            </select>
          </form>
        </ul>
