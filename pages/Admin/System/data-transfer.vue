  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand"><button type="button" class="btn btn-primary">Import Data</button></a>
        <a class="navbar-brand"><button type="button" class="btn btn-primary" style="float:left; left: 12%; position: absolute;">Export Data</button></a>
