  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand"><button type="button" class="btn btn-primary">Add New Attribute</button></a>
        <a class="navbar-brand"><button type="button" class="btn btn-primary" style="float:left; left: 12%; position: absolute;">Add New Attribute Set</button></a>
        ...
        <ul class="navbar-nav">
          ...
          <form action="/" class="filterAction">
            ...
            <select id="actions" name="actions">
              <option value="volvo">Customer Attributes</option>
              <option value="saab">Customer Address Attributes</option>
              <option value="opel">Product Attributes</option>
              <option value="opel">Returns Attributes</option>
              <option value="opel">Rating Attributes</option>
            </select>
          </form>
        </ul>
