                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input
  id="excerpt" type="textarea" validation="required|max:50,length" :help="`Keep it under 50 characters. ${50 - value.length} left.`" cols="50" rows="10" value="Add a short Description">{{ article.excerpt }}
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
...
import  articles from '~/graphql/mutations/content/article'
