    ...
    <form v-for="newsletter in newsletters" :key="newsletter.id" method="POST" @submit.prevent>
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand"><input type="submit" class="btn btn-warning" @click="addNewsletter" value="Save Newsletter" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
...
import  newsletters from '~/graphql/mutations/marketing/newsletter_subscribers'
