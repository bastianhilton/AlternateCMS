...
// eslint-disable-next-line camelcase
import  newsletter_subscribers from '~/graphql/mutations/marketing/newsletter_subscribers'
import  glossaries from '~/graphql/queries/marketing/newsletter_subscribers'
