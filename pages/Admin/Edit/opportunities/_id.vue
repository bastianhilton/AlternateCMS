<template>
    <div>
        <form  v-for="opportunities in allOpportunities" :key="opportunities.id" method="POST" enctype="multipart/form-data"  @submit.prevent>
...
import  opportunities from '~/graphql/mutations/customers/opportunities'
