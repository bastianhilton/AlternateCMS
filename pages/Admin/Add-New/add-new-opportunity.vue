    ...
    <div>
      ...
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Opportunity" @click="addOpportunity" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
...
import opportunities from "~/graphql/queries/customers/opportunities";
