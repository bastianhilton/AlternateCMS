    ...
    <form method="POST" enctype="multipart/form-data" @submit.prevent>
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Target" @click="addTarget" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
        <div class="col-3">
          ...
          <div id="v-tabs-tab" class="nav flex-column nav-tabs text-center" role="tablist" aria-orientation="vertical">
            <a id="v-tabs-home-tab" class="nav-link active" data-mdb-toggle="tab" href="#v-tabs-home" role="tab"
              aria-controls="v-tabs-home" aria-selected="true">Create A New Target</a>
          </div>
          <!-- Tab navs -->
        </div>
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <input v-model="email_opt_out" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Do Not Call</td>
                      <td>
                        <input v-model="donotcall" type="textarea" />
                      </td>
                    </tr>
                  </tbody>
                </table>
...
<script>
  ...
  import 
    targets
  from "~/graphql/queries/customers/targets";
