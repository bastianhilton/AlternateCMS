    ...
    <div>
      ...
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Category" @click="addCategory" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
                        ...
                        <table class="table" >
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input
  v-model="meta_description" type="textarea" value="Product Description" rows="10" cols="50" /></td>
                                    </tr>
                                </tbody>
                            </table>
                    </div>
