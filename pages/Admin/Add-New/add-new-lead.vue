    ...
    <form method="POST" enctype="multipart/form-data" @submit.prevent>
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Lead" @click="addLead" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
        ...
        <table class="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input v-model="office_phone" type="text" />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <input v-model="alt_city" type="text" value="Other Address City" />
              </td>
            </tr>
            <tr>
              <td style="text-align: right;">Alternate Address State</td>
              <td>
                <input v-model="alt_state" type="text" value="Other Address State" />
              </td>
            </tr>
            <tr>
              <td style="text-align: right;">Alternate Address Country</td>
              <td>
                <input v-model="alt_country" type="text" value="Other Address Country" />
              </td>
            </tr>
            <tr>
                ...
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <input v-model="status_description" type="textarea" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Opportunity Amount</td>
                      <td>
                        <input v-model="opportunity_amount" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Campaign</td>
                      <td>
                        <input v-model="campaign" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Lead Source</td>
                      <td>
                        <input v-model="lead_source" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Lead Source Description</td>
                      <td>
                        <input v-model="lead_source_description" type="textarea" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Referred By</td>
                      <td>
                        <input v-model="referred_by" type="text" />
                      </td>
                    </tr>
                  </tbody>
                </table>
...
<script>
  ...
  import 
    leads
  from "~/graphql/queries/customers/leads";
