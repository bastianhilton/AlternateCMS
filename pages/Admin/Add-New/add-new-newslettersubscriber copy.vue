<template>
    ...
    <form method="POST" @submit.prevent  enctype="multipart/form-data">
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand"><input type="submit" class="btn btn-warning" @click="addCustomer" value="Save Customer" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
  ...
  :help="`Keep it under 50 characters. ${50 - value.length} left.`" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input id="state" v-model="state" name="state" type="select" :options="states.name" placeholder="Select a State" />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input id="country" v-model="country" name="country" type="select" :options="country.name" placeholder="Select a Country" />
                      </td>
                    </tr>
                    <tr>
