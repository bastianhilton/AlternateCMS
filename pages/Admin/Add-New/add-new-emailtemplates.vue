    ...
    <form method="POST" enctype="multipart/form-data" @submit.prevent>
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Email Template" @click="addEmailtemplates" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
        ...
        <table class="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input v-model="header" type="text" placeholder="#" required />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input v-model="footer" type="text" />
              </td>
            </tr>
            <tr>
...
<script>
  ...
  import 
    email_templates
  from "~/graphql/queries/marketing/email_templates";
