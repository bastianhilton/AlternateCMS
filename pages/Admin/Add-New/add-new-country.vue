    ...
    <div>
      ...
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Country" @click="addCountry" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
              ...
              <div class="table table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input id="countriesRegion" v-model="region" type="countriesRegion" required /></td>
                    </tr>
                </tbody>
            </table>
        </div>
