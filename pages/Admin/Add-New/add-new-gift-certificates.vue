    ...
    <form method="POST" @submit.prevent  enctype="multipart/form-data">
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand"><input type="submit" class="btn btn-warning" @click="addGift_Certificate" value="Save Gift_Certificate" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
                ...
                <table class="table" >
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input id="expiration" v-model="expiration" name="expiration" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Gift Type</td>
                      <td><input id="expiration" v-model="type" name="expiration" type="text" value="Gift Card or Gift Certificate" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Description</td>
                      <td><input id="reviewDescription" v-model="excerpt" type="textarea" value="Enter information about this gift" validation="required|max:50,length" :help="`Keep it under 50 characters. ${50 - excerpt.length} left.`" />
                      </td>
                    </tr>
                  </tbody>
                </table>
...
import  gift_certificate from "~/graphql/queries/sales/gift_certificates"
