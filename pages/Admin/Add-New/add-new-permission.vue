    ...
    <form method="POST" enctype="multipart/form-data" @submit.prevent>
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Permission" @click="addPermission" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
...
<script>
  ...
  import permissions from "~/graphql/queries/system/permissions";
  import roles from "~/graphql/queries/system/roles";
  import users from "~/graphql/queries/system/users";
  ...
  const ADD_PERMISSIONS = gql `
    ...
    insert_permissions(objects: {Delete: $Delete, update: $update, users: $users, content: $content, read: $read, role: $role, created_at: $created_at, create: $create}) {
        affected_rows
        returning {
            content
            users
