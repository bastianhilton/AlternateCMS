  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand"><button type="button" class="btn btn-primary">Views</button></a>
        ...
        <ul class="navbar-nav">
          ...
          <form action="/" class="filterAction">
            ...
            <select id="actions" name="actions">
              ...
              <option value="saab">Low Stock</option>
              <option value="opel">Ordered</option>
              <option value="opel">Downloads</option>
            </select>
          </form>
        </ul>
