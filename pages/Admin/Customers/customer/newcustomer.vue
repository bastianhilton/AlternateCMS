                ...
                <table class="table" >
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input
  type="textarea" id="aboutCustomer" v-model="short_description" name="aboutCustomer" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input id="state" v-model="state" name="state" />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input id="country" v-model="country" name="country" />
                      </td>
                    </tr>
                    <tr>
