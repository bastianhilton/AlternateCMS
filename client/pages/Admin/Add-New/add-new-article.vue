        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col" class="articleAddOptions">
                <li><a href="/admin/add-new/add-new-tag">
                    <FormulateInput type="button" label="Add New Tag"></FormulateInput>
                  </a></li>
                <li>
                  <FormulateInput type="submit" label="Save" @click="addArticle" />
                </li>
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <select id="category" v-model="categories" name="template" class="form-category">
                  <option v-for="categories in categories" :key="categories" :value="categories">{{ categories.name }}
                  </option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <FormulateInput v-model="published" type="datetime-local" label="Default is published immediately" />
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select id="category" v-model="customers" name="template" class="form-category">
                  <option v-for="customers in customers" :key="customers" :value="customers">{{ customers.name }}</option>
                </select>
              </td>
            </tr>
          </tbody>
              ...
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <FormulateInput v-model="meta_description" type="textarea" label="Article Description" rows="10"
                        cols="50" />
                    </td>
                  </tr>
                  <tr>
